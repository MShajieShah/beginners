...
#   day_no = Date.strptime(date_string, '%m/%d/%Y').wday
#   DAYS[day_no]
# end
...
#   when 2
#     puts 'Dimorphic' if occs.count == 2
#   when 1
#     puts 'Enamorphic' if occs.count == 1
#   else
...
# end
#
# puts reverse_string('This is a lacipyt .ecnetnes')
#
